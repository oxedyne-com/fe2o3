...
/*
static void saber_shake128_absorb(uint64_t *s, const unsigned char *input, unsigned int inputByteLen)
{
  keccak_absorb(s, SHAKE128_RATE, input, inputByteLen, 0x1F);
}
*/

void saber_shake128(unsigned char *output, unsigned long long outlen,
...
// void csaber_shake128_simple_absorb(uint64_t s[25],
...
// void csaber_shake128_simple_squeezeblocks(unsigned char *output, unsigned long long nblocks, uint64_t *s)
// {
//   keccak_squeezeblocks(output, nblocks, s, SHAKE128_RATE);
// }

// void csaber_shake128_simple(unsigned char *output, unsigned long long outlen,
//                       uint16_t cstm, // 2-byte domain separator
//                       const unsigned char *in, unsigned long long inlen)
// {
//   uint64_t s[25];
...
//   csaber_shake128_simple_absorb(s,cstm,in,inlen);
