...
impl CalendarDate {
    ...
    /// ISO 8601 week numbering, 1 to 53.
    ...
    /// Days since year 0 in the proleptic Gregorian calendar.
    ...
    /// The Java calclock toJulianDayNumber4 algorithm, from
    ...
    /// The inverse, from the same source.
