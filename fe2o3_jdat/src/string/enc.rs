...
impl Dat {
        ...
        -> Outcome<String>
    {
        ...
        let (s, is_dataless) = match self {
            ...
            Self::Tup2u8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup3u8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup4u8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup5u8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup6u8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup7u8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup8u8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup9u8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup10u8(a)    => (Self::encode_ints(&a[..], &cfg), false),
            ...
            Self::Tup2i8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup3i8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup4i8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup5i8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup6i8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup7i8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup8i8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup9i8(a)     => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup10i8(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup2i16(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup3i16(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup4i16(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup5i16(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup6i16(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup7i16(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup8i16(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup9i16(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup10i16(a)   => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup2i32(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup3i32(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup4i32(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup5i32(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup6i32(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup7i32(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup8i32(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup9i32(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup10i32(a)   => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup2i64(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup3i64(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup4i64(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup5i64(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup6i64(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup7i64(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup8i64(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup9i64(a)    => (Self::encode_ints(&a[..], &cfg), false),
            Self::Tup10i64(a)   => (Self::encode_ints(&a[..], &cfg), false),
        };
        let kind = self.kind();
