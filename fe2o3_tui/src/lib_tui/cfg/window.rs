...
impl StyleLibrary {
        ...
        )>
    {
        ...
        let help_txt = [
            ...
            Text::from("You can enter modes or commands in one of two ways, either directly using the keys"),
            Text::from("below, or else via the menu window (numbered 0).  The menu tab of this window provides"),
            Text::from("a list of actions that changes depending upon the context."),
            Text::from("ALL MODES"),
            Text::from("  Esc:                  Exit the current mode, returning to Window Navigation mode."),
            Text::from("MENU WINDOW"),
            Text::from("  Shift + Page Up/Down: Move the action focus up/down."),
            Text::from("  Home:                 Perform the the action with the focus."),
            Text::from("WINDOW NAVIGATION MODE"),
            Text::from("  Tab:                  Move the window focus."),
            Text::from("  Space:                Enter Window Management mode for the current window."),
            Text::from("  Enter:                Enter Window Interaction mode for the current window."),
            Text::from("WINDOW MANAGEMENT MODE"),
            Text::from("  Arrow keys:           Slide the window around the screen."),
            Text::from("  Space again:          Enter the window size editor.  Pressing the space bar again"),
            Text::from("                        moves the focus to the next window border.  Use the arrow keys"),
            Text::from("                        to resize."0,
            ...
            Text::from("  Shift + Arrow:        Pan the text view."),
        ];
