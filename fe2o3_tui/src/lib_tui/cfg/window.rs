...
impl StyleLibrary {
        ...
        )>
    {
        ...
        let help_txt = [
            ...
            Text::from("below, or else via the menu window (numbered 0).  The menu tab of the menu window"),
            Text::from("provides a list of actions that changes depending upon the context."),
            Text::from("ALL MODES"),
            Text::from("  Esc:                  Exit the current mode, returning to Window Navigation mode."),
            Text::from("  Shift + Page Up/Down: Move the menu window menu tab action focus up/down."),
            Text::from("  Home:                 Perform the current menu window menu tab action."),
